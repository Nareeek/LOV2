...
- `32-original-screen-fit.css` - original-screen viewport fitting and scale constraints.
- `33-lov-window-world-panels.css` - tavern, store, forge, arena, tower, boatman, fountain, journal.
- `33-final-desktop-fit.css` - desktop viewport fit pass applied after world-panel styles.
